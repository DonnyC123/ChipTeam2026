        ...
        for f in fields(item):
            ...
            if hasattr(input_parent, field_name):
                ...
                if is_dataclass(value):
                    # DUT may expose a packed struct as one signal (no .red/.green/.blue)
                    ...
                    set_whole = (
                        ...
                        and callable(getattr(value, "to_logic_array", None))
                    )
                    if set_whole:
                        signal_or_interface.value = value.to_logic_array()
                    else:
