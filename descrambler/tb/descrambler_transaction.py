...
@dataclass
class descramblerTransaction(AbstractTransaction):
    x_64b_o:    LogicArray = field(default_factory=lambda: LogicArray("0" * 64))
    ...
    def valid_bytes(self) -> list[int]:
        ...
        raw   = int(self.out_x_64b_o_o).to_bytes(8, "little")
