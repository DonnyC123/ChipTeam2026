...
class descramblerScoreboard:
    def __init__(self, name: str = "descramblerScoreboard"):
        self.name = name
    ...
    def ingest(self, txn: descramblerTransaction):
        if not txn.valid_o and txn.n_valid == 0:
            return
    ...
    @staticmethod
    def _extract_bytes(txn: descramblerTransaction) -> list[int]:
