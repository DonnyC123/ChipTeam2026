import cocotb
from multiplier_demo.tb.fast_multiplier_test_base import FastMultiplierTestBase
...
async def sanity_test(dut):
    ...
    await testbase.sequence.add_median_op(10, 12)
    await testbase.sequence.add_median_op(200, 155)
